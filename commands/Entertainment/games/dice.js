module.exports = {
    ...
    $editMessage[$get[messageid];{newEmbed:{title:There you go!!}{description:You got a $random[1;6] out of 6!}{color:Red}}{actionRow:{button:Try Again:2:dicetryagain_$authorID:false:🕹️}}]
    $wait[3s]
