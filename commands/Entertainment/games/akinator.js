module.exports = {
  ...
  akinator(message, {
          ...
          **Note**#COLON# Features or commands that are disabled are subject to be either fixed or removed. We have no eta on when that will happen for these features/commands.
  }{color:Blurple}}]
          `
        }