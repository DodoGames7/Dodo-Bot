module.exports = [{
  ...
  $addSelectMenu[1;string;devmenu_$authorID;Select an option;1;1;false;Bot Invitation Message:Whether or not the bot should greet new servers.:botwelcome:false:👋;Error Logging:Send errors to specific channel.:errorlog:false:📢;Embed color:Change the current embed color used in all commands.:botembedcolor:false:🎨;Pre-release:Whether or not to enable Pre-release mode.:botdevmode:false:🚧;Startup:Choose a channel for bot's startup msgs to be sent.:botstartup:false:🚦;Expose build information:Whether or not to enable "Build Info" button in stats cmd:exposebuildinfo:false:🛠️]
