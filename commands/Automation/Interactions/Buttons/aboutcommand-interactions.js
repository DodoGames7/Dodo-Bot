module.exports = [{
    ...
    Builds of Tower Valley will often feature a lot of changes including improvements and bug fixes. Breaking changes has also a chance to occur requiring the user to be careful when updating the builds to the latest one.}{image:https#COLON#//us-east-1.tixte.net/uploads/dodogames.wants.solutions/Introduction-version.png}{color:$getVar[embedcolor]}}{actionRow:{button:Home:2:aboutbuttonmainpage_$authorID:false:🏠}}]
