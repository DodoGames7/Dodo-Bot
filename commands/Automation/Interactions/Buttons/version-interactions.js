...
* Updated aoi.js to more recent Github commit of version \`6.9.0\`
...
* (Source Code) Version Revisions will now appear on startup message (for consoles) if there any
