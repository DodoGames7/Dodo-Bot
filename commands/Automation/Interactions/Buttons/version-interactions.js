...
* Embed title seen in \`settings\` command has been renamed to simply \`Settings\`
* Changed the description of \`settings\` command
* Updated the current dev build of aoi.js to latest version
* Renamed \`Guess the flag\` to \`Find the flag\`
* Introduced Leveling feature (albeit with early version of it's settings)
...
* Fixed Beta commands errors in interactions being not working properly
* Fixed options for Dodo-Bot settings in \`settings\` command not being displayed properly
...
* Added two new options for developer panel
