...
$wait[2000]
$log[Dodo-Bot v$getGlobalVar[version]$if[$getGlobalVar[pre_release]==on; (build $getGlobalVar[buildNumber])] is ready to be used on the client $userTag[$botID]!]
$djsEval[const chalk = require('chalk')
...
console.log(chalk.cyan("Invite your bot here: $botInvite[36032]"))]
`
}
